...
20 IF A>0 THEN IF A<5 THEN GOTO 25
...
40 IF B>0 THEN IF B<4 THEN GOTO 45
42 PRINT "TRY AGAIN..." : GOTO 30
45 PRINT : IF B=1 THEN GOTO 50
46 IF B=2 THEN GOTO 80
47 IF B=3 THEN GOTO 90
...
120 IF G>0 THEN IF G<5 THEN GOTO 125
122 PRINT "TRY AGAIN..." : GOTO 110
125 PRINT : GOTO (G*20)+110
...
205 INPUT "YOUR FIRST KAMIKAZE MISSION (0 = no, 1 = yes) ";U
207 IF U=0 THEN S=0 : GOTO 358
210 PRINT : IF RND(100)>65 THEN GOTO 325
215 GOTO 380
220 PRINT "A NAZI, EH?  OH WELL.  ARE YOU GOING FOR RUSSIA(1),"
230 INPUT "ENGLAND(2), OR FRANCE(3) ";M : IF M>0 THEN IF M<4 THEN GOTO 235
232 PRINT "TRY AGAIN..." : GOTO 220
235 PRINT : GOTO (M*10) + 240
...
365 IF S+T>(100*RND(100))/100 THEN GOTO 380
...
390 PRINT:PRINT:PRINT:INPUT "ANOTHER MISSION (0 = no, 1 = yes) ";U
395 IF U#0 THEN GOTO 8
