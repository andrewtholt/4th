...
43 INPUT A: IF A=3 THEN GOTO 46
...
53 INPUT A: IF A=2 THEN GOTO 56
...
63 INPUT A: IF A=4 THEN GOTO 66
...
73 INPUT A: IF A=3 THEN GOTO 76
74 PRINT "OH, COME ON NOW...IT WAS SNOW WHITE."
75 GOTO 80
76 PRINT "GOOD MEMORY!"
77 R=R+1
80 PRINT:PRINT
85 IF R=4 THEN GOTO 100
90 IF R<2 THEN GOTO 200
